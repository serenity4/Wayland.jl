...
@enum WpPresentationError::Int32 begin
        WP_PRESENTATION_INVALID_TIMESTAMP = 0
        WP_PRESENTATION_INVALID_FLAG = 1
    end

@bitmask WpPresentationFeedbackKind::UInt32 begin
        WP_PRESENTATION_FEEDBACK_VSYNC = 1
        WP_PRESENTATION_FEEDBACK_HW_CLOCK = 2
        WP_PRESENTATION_FEEDBACK_HW_COMPLETION = 4
        WP_PRESENTATION_FEEDBACK_ZERO_COPY = 8
    end

@enum WpViewporterError::Int32 WP_VIEWPORTER_VIEWPORT_EXISTS = 0

@enum WpViewportError::Int32 begin
        WP_VIEWPORT_BAD_VALUE = 0
        WP_VIEWPORT_BAD_SIZE = 1
        WP_VIEWPORT_OUT_OF_BUFFER = 2
        WP_VIEWPORT_NO_SURFACE = 3
    end

@enum XdgWmBaseError::Int32 begin
        XDG_WM_BASE_ROLE = 0
        XDG_WM_BASE_DEFUNCT_SURFACES = 1
        XDG_WM_BASE_NOT_THE_TOPMOST_POPUP = 2
        XDG_WM_BASE_INVALID_POPUP_PARENT = 3
        XDG_WM_BASE_INVALID_SURFACE_STATE = 4
        XDG_WM_BASE_INVALID_POSITIONER = 5
    end

@enum XdgPositionererrorError::Int32 XDG_POSITIONERERROR_INVALID_INPUT = 0

@enum XdgPositioneranchorAnchor::Int32 begin
        XDG_POSITIONERANCHOR_NONE = 0
        XDG_POSITIONERANCHOR_TOP = 1
        XDG_POSITIONERANCHOR_BOTTOM = 2
        XDG_POSITIONERANCHOR_LEFT = 3
        XDG_POSITIONERANCHOR_RIGHT = 4
        XDG_POSITIONERANCHOR_TOP_LEFT = 5
        XDG_POSITIONERANCHOR_BOTTOM_LEFT = 6
        XDG_POSITIONERANCHOR_TOP_RIGHT = 7
        XDG_POSITIONERANCHOR_BOTTOM_RIGHT = 8
    end

@enum XdgPositionergravityGravity::Int32 begin
        XDG_POSITIONERGRAVITY_NONE = 0
        XDG_POSITIONERGRAVITY_TOP = 1
        XDG_POSITIONERGRAVITY_BOTTOM = 2
        XDG_POSITIONERGRAVITY_LEFT = 3
        XDG_POSITIONERGRAVITY_RIGHT = 4
        XDG_POSITIONERGRAVITY_TOP_LEFT = 5
        XDG_POSITIONERGRAVITY_BOTTOM_LEFT = 6
        XDG_POSITIONERGRAVITY_TOP_RIGHT = 7
        XDG_POSITIONERGRAVITY_BOTTOM_RIGHT = 8
    end

@bitmask XdgPositionerconstraintAdjustmentConstraintAdjustment::UInt32 begin
        XDG_POSITIONERCONSTRAINT_ADJUSTMENT_NONE = 0
        XDG_POSITIONERCONSTRAINT_ADJUSTMENT_SLIDE_X = 1
        XDG_POSITIONERCONSTRAINT_ADJUSTMENT_SLIDE_Y = 2
        XDG_POSITIONERCONSTRAINT_ADJUSTMENT_FLIP_X = 4
        XDG_POSITIONERCONSTRAINT_ADJUSTMENT_FLIP_Y = 8
        XDG_POSITIONERCONSTRAINT_ADJUSTMENT_RESIZE_X = 16
        XDG_POSITIONERCONSTRAINT_ADJUSTMENT_RESIZE_Y = 32
    end

@enum XdgSurfaceError::Int32 begin
        XDG_SURFACE_NOT_CONSTRUCTED = 1
        XDG_SURFACE_ALREADY_CONSTRUCTED = 2
        XDG_SURFACE_UNCONFIGURED_BUFFER = 3
    end

@enum XdgToplevelError::Int32 XDG_TOPLEVEL_INVALID_RESIZE_EDGE = 0

@enum XdgToplevelResizeEdge::Int32 begin
        XDG_TOPLEVEL_NONE = 0
        XDG_TOPLEVEL_TOP = 1
        XDG_TOPLEVEL_BOTTOM = 2
        XDG_TOPLEVEL_LEFT = 4
        XDG_TOPLEVEL_TOP_LEFT = 5
        XDG_TOPLEVEL_BOTTOM_LEFT = 6
        XDG_TOPLEVEL_RIGHT = 8
        XDG_TOPLEVEL_TOP_RIGHT = 9
        XDG_TOPLEVEL_BOTTOM_RIGHT = 10
    end

@enum XdgToplevelState::Int32 begin
        XDG_TOPLEVEL_MAXIMIZED = 1
        XDG_TOPLEVEL_FULLSCREEN = 2
        XDG_TOPLEVEL_RESIZING = 3
        XDG_TOPLEVEL_ACTIVATED = 4
        XDG_TOPLEVEL_TILED_LEFT = 5
        XDG_TOPLEVEL_TILED_RIGHT = 6
        XDG_TOPLEVEL_TILED_TOP = 7
        XDG_TOPLEVEL_TILED_BOTTOM = 8
    end

@enum XdgPopupError::Int32 XDG_POPUP_INVALID_GRAB = 0
